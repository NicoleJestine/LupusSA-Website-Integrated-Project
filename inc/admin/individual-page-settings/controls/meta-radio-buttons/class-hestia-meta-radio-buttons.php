...
class Hestia_Meta_Radio_Buttons {
	...
	public function enqueue() {
		wp_enqueue_script( 'hestia-meta-radio-buttons-script', get_template_directory_uri() . '/inc/admin/individual-page-settings/controls/meta-radio-buttons/script.js', array( 'jquery', 'jquery-ui-button' ), HESTIA_VERSION, true );
		wp_enqueue_style( 'hestia-meta-radio-buttons-style', get_template_directory_uri() . '/inc/admin/individual-page-settings/controls/meta-radio-buttons/style.css', array(), HESTIA_VERSION );
	}
